...
export const ar = {
  ...
  staticModeHint: "يعمل من جهازك مباشرة — يوتيوب وتيك توك وإنستغرام وأكثر، بدون سيرفر",
  staticProxyRequired:
    "تعذّر الوصول للمنصة — جرّب رابطاً آخر أو انتظر قليلاً",
  ready: "من جهازك",
  ...
  version: "1.0.23",
  madeWithLove: "صُنع ب ❤️ بواسطة عبدالرحمن المحمد",
